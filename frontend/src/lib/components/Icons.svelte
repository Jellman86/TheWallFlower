<script>
  /** Simple SVG icons component for Svelte 5 */
...
>
  ...
  {:else if name === 'scan-face'}
    <path d="M3 7V5a2 2 0 0 1 2-2h2m12 0h2a2 2 0 0 1 2 2v2m0 12v2a2 2 0 0 1-2 2h-2M7 21H5a2 2 0 0 1-2-2v-2m4-5a4 4 0 0 1 8 0"></path>
  {:else if name === 'volume'}
