...
class Go2RTCClient:
    ...
    def __init__(
        ...
        Args:
            ...
            port: go2rtc HTTP API port (default: from GO2RTC_PORT env or 1984)
            rtsp_port: go2rtc RTSP port (default: from GO2RTC_RTSP_PORT env or 8554)
            webrtc_port: go2rtc WebRTC port (default: from GO2RTC_WEBRTC_PORT env or 8555)
            timeout: Request timeout in seconds
        """
        self.host = host or os.getenv("GO2RTC_HOST", "localhost")
        self.port = port or int(os.getenv("GO2RTC_PORT", "1984"))
        self.rtsp_port = rtsp_port or int(os.getenv("GO2RTC_RTSP_PORT", "8554"))
        self.webrtc_port = webrtc_port or int(os.getenv("GO2RTC_WEBRTC_PORT", "8555"))
